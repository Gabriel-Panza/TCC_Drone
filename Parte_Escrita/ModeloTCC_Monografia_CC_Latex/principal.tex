...
\hypersetup{
        ...
        pdfkeywords={navegação autônoma}{visão monocular}{profundidade}{mapeamento tridimensional}{VANT},
...
% Página opcional desativada: dedicatória do trabalho à família.
%\input{elementos-pretextuais/dedicatoria}
\input{elementos-pretextuais/agradecimentos}
\input{elementos-pretextuais/etica}
% Página opcional desativada: epígrafe de Isaac Newton sobre os ombros de gigantes.
...
\include{elementos-textuais/capitulo1}
\include{elementos-textuais/capitulo2}
\include{elementos-textuais/capitulo3}
\include{elementos-textuais/capitulo4}
\include{elementos-textuais/capitulo5}
\include{elementos-textuais/capitulo6}
...
% ----------------------------------------------------------
\bibliography{elementos-postextuais/monografia}
