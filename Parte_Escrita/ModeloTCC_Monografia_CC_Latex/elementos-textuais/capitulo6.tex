...
Os atributos tabulares resumem as imagens e perdem informação espacial. Os eventos de proximidade são desbalanceados, o que limita a interpretação de F1 alto. A MLP foi repetida com cinco sementes e as ablações com três, mas Random Forest e Extra Trees foram executados apenas com a semente 42. Diferenças pequenas entre famílias permanecem descritivas, sem teste de hipótese ou intervalo de confiança das árvores. A curva de crescimento mostra o intervalo de confiança de 95\% somente no marco final, único repetido em cinco sementes; a ablação mostra a dispersão das três sementes pareadas.
