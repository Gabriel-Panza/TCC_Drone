...
A base final reuniu 103 execuções completas e 8.305 intervalos. A MLP apresentou resultados estáveis entre sementes e superou a referência constante nos alvos analisados. Diferença de imagem, movimento e sinais inerciais concentraram parte importante da informação, enquanto os erros do percentil distante permaneceram altos. Na etapa espacial, a profundidade do Gazebo permitiu completar dez de dez runs sem adotar caminhos inseguros. O mesmo não ocorreu com as versões monoculares v12 a v19. Elas podiam obter métricas por pixel aceitáveis e, ainda assim, produzir falso espaço livre ou poucos caminhos executáveis.
