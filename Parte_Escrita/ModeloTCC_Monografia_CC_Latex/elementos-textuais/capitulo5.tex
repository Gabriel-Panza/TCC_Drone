...
\begin{figure}[htb]
    ...
    \caption{MAE da MLP e da média do treino nos cinco marcos, com teste fixo. O marcador com barras no marco final mostra o intervalo de confiança de 95\% da MLP em cinco sementes; os marcos anteriores não foram repetidos.}
...
\begin{figure}[htb]
    ...
    \caption{Sensibilidade por gradientes e efeito da retirada dos grupos de entradas. As barras da ablação mostram a dispersão média entre as três sementes pareadas.}
