...
A versão v19 usou 20 execuções completas no treino e uma execução apenas para calibração. O treino efetivo registrou 3.322 quadros, com repetição dirigida de quatro execuções de foco. A terceira execução da bateria final, \texttt{run\_20260831\_082836\_332335}, forneceu os 77 quadros de validação durante o treinamento e também foi o conjunto primário do portão. Portanto, ela não é um teste independente.
