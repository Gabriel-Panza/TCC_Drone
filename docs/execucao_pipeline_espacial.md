...
O planejador remove curvas discretas quando existe linha de visada inteiramente observada e livre. O caminho resultante e dividido em pontos com no maximo 6,5 m. Caminhos locais terminam 2,5 m antes da fronteira observada, e um novo plano e solicitado quando restam menos de 4 m. Uma falha nessa tentativa antecipada preserva o caminho atual. Se o caminho acabar ou ficar inseguro sem uma alternativa, o drone recua 2,5 m por posicoes seguras ja voadas antes de tentar novamente. A amostragem `spatial_depth_stride=35` preserva a grade de 0,75 m com menor custo de integracao.
