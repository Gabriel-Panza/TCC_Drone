...
metadata="config/depth_v12_training.json"
...
selection="datasets/spatial_mapping/training_selections/v12_tree_hard_frames.json"
checkpoint="models/depth_anything_v2_metric_baylands_vits_v8.pth"
output="models/depth_anything_v2_metric_baylands_vits_v12.pth"
onnx_output="models/depth_anything_v2_metric_baylands_vits_v12_686x518_fp32.onnx"
log="logs/training/depth_v12.log"
...
train_command=(
  ...
  --epochs 6 --encoder vits --freeze-encoder --batch-size 2 --head-lr 3e-6
  --focus-repeat 1 --focus-frame-repeat 4
...
echo "4/6 Treinando Small v12 com perda bidirecional..."
mkdir -p "$(dirname "$log")"
...
echo "Log: $log"
echo "Nao execute SITL; o proximo passo e o gate offline v12."
