...
metadata="config/depth_v17_training.json"
...
selection="datasets/spatial_mapping/training_selections/v17_balanced_complete_frames.json"
checkpoint="models/depth_anything_v2_metric_baylands_vits_v16.pth"
output="models/depth_anything_v2_metric_baylands_vits_v17.pth"
onnx_output="models/depth_anything_v2_metric_baylands_vits_v17_686x518_fp32.onnx"
log="logs/training/depth_v17.log"
...
train_command=(
  ...
  --epochs 3 --encoder vits --freeze-encoder --batch-size 2 --head-lr 1e-6
  --focus-repeat 1 --focus-frame-repeat 3
  --edge-multiplier 3.5 --unsafe-tail-weight 0.08
  --unsafe-overestimate-weight 0.50
...
echo "4/6 Treinando Small v17 com perda balanceada em corpus ampliado..."
mkdir -p "$(dirname "$log")"
...
echo "Log: $log"
echo "Nao execute SITL; o proximo passo e o gate offline v17."
