...
metadata="config/depth_v14_training.json"
...
selection="datasets/spatial_mapping/training_selections/v14_tree_hard_frames.json"
checkpoint="models/depth_anything_v2_metric_baylands_vits_v12.pth"
output="models/depth_anything_v2_metric_baylands_vits_v14.pth"
onnx_output="models/depth_anything_v2_metric_baylands_vits_v14_686x518_fp32.onnx"
log="logs/training/depth_v14.log"
...
echo "4/6 Treinando Small v14 com perda bidirecional..."
mkdir -p "$(dirname "$log")"
...
echo "Log: $log"
echo "Nao execute SITL; o proximo passo e o gate offline v14."
