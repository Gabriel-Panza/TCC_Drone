...
cd "$project_dir"
output="logs/spatial_offline_sweep/manual_blockage_diagnostic_01"
...
echo "3/4 Isolando faixa vertical e incerteza no percurso antigo..."
python3 scripts/run_spatial_offline_sweep.py \
  --matrix config/spatial_blockage_hypothesis_sweep.json \
