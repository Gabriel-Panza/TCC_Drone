...
cd "$project_dir"
output="logs/spatial_offline_sweep/manual_free_margin_01"
...
echo "3/4 Comparando apenas a margem livre conservadora..."
python3 scripts/run_spatial_offline_sweep.py \
  --matrix config/spatial_free_margin_safety_sweep.json \
