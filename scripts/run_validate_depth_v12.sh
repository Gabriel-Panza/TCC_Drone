...
[[ -f "$model" ]] || { echo "Modelo v12 ausente; rode ./scripts/run_train_depth_v12.sh" >&2; exit 2; }
...
echo "  models/monocular_validation_v12_heldout.json"
echo "  models/monocular_validation_v12_independent.json"
