...
metadata="config/depth_v18_training.json"
...
selection="datasets/spatial_mapping/training_selections/v18_balanced_complete_frames.json"
checkpoint="models/depth_anything_v2_metric_baylands_vits_v16.pth"
output="models/depth_anything_v2_metric_baylands_vits_v18.pth"
onnx_output="models/depth_anything_v2_metric_baylands_vits_v18_686x518_fp32.onnx"
log="logs/training/depth_v18.log"
...
train_command=(
  ...
  --epochs 3 --encoder vits --freeze-encoder --batch-size 2 --head-lr 8e-7
  --focus-repeat 1 --focus-frame-repeat 3
...
echo "4/6 Treinando Small v18 com perda bidirecional nos corredores indisponiveis..."
mkdir -p "$(dirname "$log")"
...
echo "Log: $log"
echo "Nao execute SITL; o proximo passo e o gate offline v18."
